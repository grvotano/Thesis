...
data['R_Deaths'] = data['N_Deaths'] * (data['class']/data['total_h'])
data['R_Damages'] = data['N_D_USD'] * (data['class']/data['total_h'])

# export to csv
data_clean = data[['NAME_1_x',"Year",'GID_1_2', 'disaster','began', 'ended','N_Deaths', 'N_D_USD','R_Deaths', 'R_Damages' ]]
data.to_csv(r'TC_Impacts_Redistribute_By_Hazard.csv')
data_clean.to_csv(r'TC_CLean_Impacts_Redistribute_By_Hazard.csv')
