...
flood['R_Deaths'] = flood['N_Deaths'] * (((flood['FloodClass']/flood['total_h']) + (flood['Sumsum']/flood['total_pop']))/2)
flood['R_Damages'] = flood['N_D_USD'] * (((flood['FloodClass']/flood['total_h']) + (flood['Sumsum']/flood['total_pop']))/2)
data = flood
# export to csv
data_clean = data[['NAME_1_x',"Year",'GID_1_2', 'disaster','began', 'ended','N_Deaths', 'N_D_USD','R_Deaths', 'R_Damages' ]]
data.to_csv(r'FL_Impacts_HRPop.csv')
data_clean.to_csv(r'FL_CLean_Impacts_HRPop.csv')
