...
data['R_Deaths'] = data['N_Deaths'] * (((data['R_Class']/data['total_h']) + (data['Sumsum']/data['total_pop']))/2)
data['R_Damages'] = data['N_D_USD'] * (((data['R_Class']/data['total_h']) + (data['Sumsum']/data['total_pop']))/2)
